	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="注射疫苗" prop="zhusheyimiao">
					<el-select :disabled="ro.zhusheyimiao" v-model="ruleForm.zhusheyimiao" placeholder="请选择注射疫苗" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="注射疫苗" prop="zhusheyimiao">
					<el-input v-model="ruleForm.zhusheyimiao"
						placeholder="注射疫苗" readonly></el-input>
				</el-form-item>
