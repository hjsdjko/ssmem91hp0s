<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="申请编号" prop="shenqingbianhao">
					<el-input v-model="ruleForm.shenqingbianhao" placeholder="申请编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shenqingbianhao" label="申请编号" prop="shenqingbianhao">
					<el-input v-model="ruleForm.shenqingbianhao" placeholder="申请编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="动物名称" prop="dongwumingcheng">
					<el-input v-model="ruleForm.dongwumingcheng" placeholder="动物名称" clearable  :readonly="ro.dongwumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="动物名称" prop="dongwumingcheng">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="领养姓名" prop="lingyangxingming">
					<el-input v-model="ruleForm.lingyangxingming" placeholder="领养姓名" clearable  :readonly="ro.lingyangxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="领养姓名" prop="lingyangxingming">
					<el-input v-model="ruleForm.lingyangxingming" placeholder="领养姓名" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="住址" prop="zhuzhi">
					<el-input v-model="ruleForm.zhuzhi" placeholder="住址" clearable  :readonly="ro.zhuzhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="住址" prop="zhuzhi">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="领养原因" prop="lingyangyuanyin">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.lingyangyuanyin" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.lingyangyuanyin" label="领养原因" prop="lingyangyuanyin">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.lingyangyuanyin"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='lingyangxingming'){
							this.ruleForm.lingyangxingming = obj[o];
							this.ro.lingyangxingming = true;
							continue;
						}
						if(o=='lianxidianhua'){
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.zhanghao!=''&&json.zhanghao) || json.zhanghao==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.lingyangzhanghao = json.zhanghao
						this.ro.lingyangzhanghao = true;
					}
					if(((json.xingming!=''&&json.xingming) || json.xingming==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.lingyangxingming = json.xingming
						this.ro.lingyangxingming = true;
					}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.lingyangyuanyin = this.ruleForm.lingyangyuanyin.replace(reg,'../../../ssmem91hp0s/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
